    ...
    <div class="hero-slider owl-carousel">
        <div class="hero-slider__item hero-slider__item--1">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="slide-up">
                            <div class="t-mt-30 d-flex align-items-center">
                                <a href="about.html" class="t-link bttn bttn-lg bttn-round bttn-primary text-capitalize t-mr-16">
                                    get started
                                </a>
                                <a
                                    href="#"
            ...
            <div class="hero-slider__img">
                <img
                    src="{{ asset('zolfin/assets/img/banner-slider-img.png') }}"
                    alt="zolfin"
        ...
        <div class="hero-slider__item hero-slider__item--2">
            ...
            <div class="hero-slider__img">
                <img
                    src="{{ asset('zolfin/assets/img/hero-img-2.png') }}"
                    alt="zolfin"
                    class="img-fluid hero-slider__img-is"
                />
            </div>
        ...
        <div class="hero-slider__item hero-slider__item--3">
            ...
            <div class="hero-slider__img">
                <img
                    src="{{ asset('zolfin/assets/img/hero-img-3.png') }}"
                    alt="zolfin"
                    class="img-fluid hero-slider__img-is"
                />
            </div>
                ...
                <div class="col-md-4 t-mb-30 mb-md-0" >
                    <div class="cards border">
                        <div class="cards__img mx-auto">
                            <img
                                src="{{ asset('zolfin/assets/img/showcase-icon-1.png') }}"
                                alt="zolfin"
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 t-mb-50 mb-lg-0" data-sal="slide-right" data-sal-duration="1300">
                    <img
                        src="{{ asset('zolfin/assets/img/about-img.png') }}"
                        alt="zolfin"
                        class="img-fluid"
                    />
                </div>
                    ...
                    <div class="service-slider">
                        <div class="service-slider__item">
                            <div class="cards border">
                                <div class="cards__img mx-auto ml-lg-0">
                                    <img
                                        src="{{ asset('zolfin/assets/img/showcase-icon-4.png') }}"
                                        alt="zolfin"
                                        class="img-fluid w-100"
                                    />
                                </div>
                        ...
                        <div class="service-slider__item">
                            <div class="cards border">
                                <div class="cards__img mx-auto ml-lg-0">
                                    <img
                                        src="{{ asset('zolfin/assets/img/showcase-icon-5.png') }}"
                                        alt="zolfin"
                                        class="img-fluid w-100"
                                    />
                                </div>
                        ...
                        <div class="service-slider__item">
                            <div class="cards border">
                                <div class="cards__img">
                                    <img
                                        src="{{ asset('zolfin/assets/img/showcase-icon-6.png') }}"
                                        alt="zolfin"
                                        class="img-fluid w-100"
                                    />
                                </div>
                        ...
                        <div class="service-slider__item">
                            <div class="cards border">
                                <div class="cards__img">
                                    <img
                                        src="{{ asset('zolfin/assets/img/showcase-icon-7.png') }}"
                                        alt="zolfin"
                                        class="img-fluid w-100"
                                    />
                                </div>
                                ...
                                <div class="project-card">
                                    <div class="project-card__img">
                                        <a href="#" class="t-link w-100">
                                            <img
                                                src="{{ asset('zolfin/assets/img/project-img-1.png') }}"
                                                alt="zolfin"
                                                class="img-fluid w-100"
                                            />
                                        </a>
                            ...
                            <div class="project-slider__item">
                                <div class="project-card">
                                    <div class="project-card__img">
                                        <a href="#" class="t-link w-100">
                                            <img
                                                src="{{ asset('zolfin/assets/img/project-img-2.png') }}"
                                                alt="zolfin"
                                                class="img-fluid w-100"
                                            />
                                        </a>
                            ...
                            <div class="project-slider__item">
                                <div class="project-card">
                                    <div class="project-card__img">
                                        <a href="#" class="t-link w-100">
                                            <img
                                                src="{{ asset('zolfin/assets/img/project-img-3.png') }}"
                                                alt="zolfin"
                                                class="img-fluid w-100"
                                            />
                                        </a>
                            ...
                            <div class="row">
                                ...
                                >
                                    <div class="price-card border">
                                        ...
                                        >
                                            <img
                                                src="{{ asset('zolfin/assets/img/price-img-1.png') }}"
                                                alt="zolfin"
                                                class="img-fluid w-100"
                                            />
                                        </div>
                                ...
                                >
                                    <div class="price-card border">
                                        ...
                                        >
                                            <img
                                                src="{{ asset('zolfin/assets/img/price-img-2.png') }}"
                                                alt="zolfin"
                                                class="img-fluid w-100"
                                            />
                                        </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="price-card border">
                                        ...
                                        >
                                            <img
                                                src="{{ asset('zolfin/assets/img/price-img-3.png') }}"
                                                alt="zolfin"
                                                class="img-fluid w-100"
                                            />
                                        </div>
                    ...
                    <div class="testimonials-slider">
                        <div class="testimonials-slider__item">
                            <div class="testimonials">
                                <div class="testimonials__img-box mx-auto ml-md-0 mr-md-3">
                                    <img src="{{ asset('zolfin/assets/img/user-2.jpg') }}" alt="zolfin" class="img-fluid w-100"/>
                                </div>
                                <div
                        ...
                        <div class="testimonials-slider__item">
                            <div class="testimonials">
                                ...
                                >
                                    <img
                                        src="{{ asset('zolfin/assets/img/user-3.jpg') }}"
                                        alt="zolfin"
                                        class="img-fluid w-100"
                                    />
                                </div>
                        ...
                        <div class="testimonials-slider__item">
                            <div class="testimonials">
                                ...
                                >
                                    <img
                                        src="{{ asset('zolfin/assets/img/user.jpg') }}"
                                        alt="zolfin"
                                        class="img-fluid w-100"
                                    />
                                </div>
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0">
                    <div class="price-card border t-bg-light">
                        <div class="price-card__img text-center mx-auto">
                            <a href="#" class="t-link">
                                <img
                                    src="{{ asset('zolfin/assets/img/process-icon-1.png') }}"
                                    alt="zolfin"
                                    class="img-fluid w-100"
                                />
                            </a>
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0 align-self-xl-end">
                    <div class="price-card border t-bg-light">
                        <div class="price-card__img text-center mx-auto">
                            <a href="#" class="t-link">
                                <img
                                    src="{{ asset('zolfin/assets/img/process-icon-2.png') }}"
                                    alt="zolfin"
                                    class="img-fluid w-100"
                                />
                            </a>
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0">
                    <div class="price-card border t-bg-light">
                        <div class="price-card__img text-center mx-auto">
                            <a href="#" class="t-link">
                                <img
                                    src="{{ asset('zolfin/assets/img/process-icon-3.png') }}"
                                    alt="zolfin"
                                    class="img-fluid w-100"
                                />
                            </a>
                ...
                <div class="col-md-6 col-lg-3 t-mb-30 mb-lg-0 align-self-xl-end">
                    <div class="price-card border t-bg-light">
                        <div class="price-card__img text-center mx-auto">
                            <a href="#" class="t-link">
                                <img
                                    src="{{ asset('zolfin/assets/img/process-icon-4.png') }}"
                                    alt="zolfin"
                                    class="img-fluid w-100"
                                />
                            </a>
                            ...
                            <div class="col-md-7 ">
                                <div class="zl-cta__left">
                                    <div class="zl-cta__left-img">
                                        <img src="{{ asset('zolfin/assets/img/cta-img.png') }}" alt="zolfin" class="img-fluid h-100 w-100">
                                    </div>
